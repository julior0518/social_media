...
const UserProfile = () => {
    ...
    const { userId } = useParams() ///// get info from dynamic URL
    ...
    if(!user){ return <Spinner message="Loading you..." />}
    return (
        <div className="relative pb-2 h-full justify-center items-center">
            <div className="flex flex-col pb-5">
                <div className="relative flex flex-col mb-7">
                    <div className="flex flex-col justify-center items-center">
                        <img src={randomImg} className="w-full h-370 xl:h-510 shadow-lg object-cover" alt="banner"/>
